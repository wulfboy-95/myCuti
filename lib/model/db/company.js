  ...
  var Company = sequelize.define("Company", {
    ...
    classMethods: {
      ...
      scopeAssociate : function( models ) {
        // Following code is here for reference only: to help declaring scoped
        // associations in future. The approach is not suitable for active users
        // because of its dynamic nature - we need to have up to date "now", which
        // does not work nicely with association as they are installed once at the
        // application start time, and if the app will be running for more than one
...
//        });
      ...
      // That means company only shows holidays/timeoff for employees and
      ...
      create_default_company : function(args){
        var country_code = args.country_code || 'MY',
          timezone = args.timezone || 'Asia/Kuala_Lumpur';
    ...
    instanceMethods : {
      ...
      // in database, return default one
      ...
      // Return TRUE if company has restriction only to show holidays for its
