...
module.exports = function(sequelize, DataTypes) {
  ...
  var User = sequelize.define("User", {
      ...
      position : {
        ...
        comment      : 'Position of the employee in the company.',
      },
      staff_no : {
        type         : DataTypes.STRING,
        allowNull    : true,
        defaultValue : "00000",
        comment      : 'Staff number of the employee.'
      },
      address : {
        type      : DataTypes.STRING,
        allowNull : true,
        comment   : "Staff contact address.",
      },
      tel_no : {
        type      : DataTypes.STRING,
        allowNull : true,
        comment   : "Staff telephone number.",
      },
  }, {
      indexes : [
        {
...
function get_instance_methods(sequelize) {
  ...
  return {
    ...
    // In fact this method probably have to be ditched in favor of more granular ones
    //
    ...
    promise_coworkers : function() {
      if (this.is_admin()) {
        ...
        .then(department => {
          ...
          return Promise.resolve( department.users );
        });
      }
    },
    /*
    ...
    reload_with_coworker_details : function() {
      var self = this;
      return Promise.join(
        self.promise_coworkers(),
        coworkers => {
    ...
    reload_with_leave_details : function(args){
      ...
      return Promise.join(
        ...
        self.promise_coworkers(),
        function(leaves, department, schedule, coworkers){
