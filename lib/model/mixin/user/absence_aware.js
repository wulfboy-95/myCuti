...
module.exports = function(sequelize){
  ...
  this.promise_duty_replacements = function() {
    let self = this;
    //This function returns an empty array for some strange reason.
    return sequelize.models.Leave.findAll({
      include : [
        {
          model : sequelize.models.User,
      ...
      where : {
        duty_status : [
          sequelize.models.Leave.duty_unconfirmed(),
          sequelize.models.Leave.duty_confirmed(),
        ],
        status : [
          sequelize.models.Leave.status_new(),
          sequelize.models.Leave.status_approved(),
        ],
        duty_replacer : [ this.id ],
      }
    })
    .then(duties => Promise.resolve(duties)); // should I sort them?
  };
  ...
  this.promise_to_update_adjustment = function(args) {
    ...
    // Update related allowance adjustment record
