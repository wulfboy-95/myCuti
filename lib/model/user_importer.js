...
const add_user_interface_schema = Joi.object().required().keys({
    ...
    staff_no      : Joi.string().default('').allow(null),
    address       : Joi.string().default('').allow(null),
    tel_no        : Joi.string().default('').allow(null),
...
function add_user(args) {
  ...
  attributes.staff_no        = args.staff_no;
  attributes.address = args.address;
  attributes.tel_no          = args.tel_no;
...
function add_users_in_bulk(args) {
  ...
  let company,
    ...
    position_vector_index   = 3,
    staff_no_vector_index   = 4,
    department_vector_index = 5,
    address_vector_index    = 6,
    tel_no_vector_index     = 7;
    ...
    return Promise.map(bulk_data, vector => {
      ...
      return Promise.resolve()
        .then(() => add_user({
          ...
          position      : vector[ position_vector_index ],
          staff_no      : vector[ staff_no_vector_index ],
          address       : vector[ address_vector_index ],
          tel_no        : vector[ tel_no_vector_index ],
