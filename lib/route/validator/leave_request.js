...
module.exports = function(args){
  ...
  /*
	if (!validator.isAlphanumeric(reason)) {
		throw new Error('Reason has wierd stuff in it');	
	}
  */
    ...
    /*
    if ( attachment ) {
    // save attachment in table, set valid_attributes.attachmentId to saved attachment's Id in table
