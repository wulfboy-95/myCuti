...
module.exports = function(args){
    ...
    var user           = validator.trim( req.param('user') ),
        ...
        duty_replacer  = parseInt(validator.trim( req.param('replacer'))),
        duty_detail    = validator.trim( req.param('duty_detail'));
    ...
    var date_validator = function(date_str, label) {
      try {
        ...
        // Ensure that normalization went OK
    ...
    // Check if it makes sense to continue validation (as following code relies on
